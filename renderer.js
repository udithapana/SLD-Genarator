...
const page = inner => `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 ${A4W} ${A4H}" font-family="Arial, Helvetica, sans-serif"><rect width="${A4W}" height="${A4H}" fill="#fff"/>${inner}</svg>`;
...
bx(565,pTop,305,pBot-pTop,'8 4');t(565,pTop-6,`MAIN SWITCHGEAR PANEL ${g('panel')}A`,11,'start','bold');
